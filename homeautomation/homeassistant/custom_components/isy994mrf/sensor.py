...
from . import isy994mrf_NODES, isy994mrf_WEATHER, ISYDevice
...
def setup_platform(hass, config: ConfigType,
    ...
    """Set up the isy994mrf sensor platform."""
    devices = []
    ...
    for node in hass.data[isy994mrf_WEATHER]:
...
class ISYSensorDevice(ISYDevice):
    """Representation of an isy994mrf sensor device."""

    @property
    def raw_unit_of_measurement(self) -> str:
        """Get the raw unit of measurement for the isy994mrf sensor device."""
    ...
    @property
    def state(self) -> str:
        """Get the state of the isy994mrf sensor device."""
        if self.is_unknown():
            return None
    ...
    def unit_of_measurement(self) -> str:
        """Get the unit of measurement for the isy994mrf sensor device."""
        raw_units = self.raw_unit_of_measurement
...
class ISYWeatherDevice(ISYDevice):
    """Representation of an isy994mrf weather device."""
