"""Support for isy994mrf binary sensors."""
...
def setup_platform(hass, config: ConfigType,
    ...
    """Set up the isy994mrf binary sensor platform."""
    devices = []
    devices_by_nid = {}
    child_nodes = []
    ...
    for name, status, _ in hass.data[isy994mrf_PROGRAMS][DOMAIN]:
...
class ISYBinarySensorDevice(ISYDevice, BinarySensorDevice):
    """Representation of an isy994mrf binary sensor device.
    ...
    def __init__(self, node) -> None:
        """Initialize the isy994mrf binary sensor device."""
        super().__init__(node)
    ...
    @property
    def is_on(self) -> bool:
        """Get whether the isy994mrf binary sensor device is on.
...
class ISYBinarySensorHeartbeat(ISYDevice, BinarySensorDevice):
    """Representation of the battery state of an isy994mrf sensor."""
...
class ISYBinarySensorProgram(ISYDevice, BinarySensorDevice):
    """Representation of an isy994mrf binary sensor program.
    ...
    def __init__(self, name, node) -> None:
        """Initialize the isy994mrf binary sensor program."""
        super().__init__(node)
        self._name = name
